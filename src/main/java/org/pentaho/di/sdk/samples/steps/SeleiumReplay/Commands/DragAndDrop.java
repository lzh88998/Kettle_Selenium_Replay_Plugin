...
public class DragAndDrop extends BaseCommand {

	public DragAndDrop(SeleniumTestCase testCase, JSONObject json) {
		super(testCase, json);
	...
	public void run() throws KettleException {
		...
		act.dragAndDrop(ele, getElement(getValue())).perform();
	}
}
