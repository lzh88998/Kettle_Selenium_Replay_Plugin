...
public class WaitForElementVisible extends BaseCommand {

	public WaitForElementVisible(SeleniumTestCase testCase, JSONObject json) {
		super(testCase, json);
	...
	public void run() throws KettleException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(getTargetLocator(getTarget())));
