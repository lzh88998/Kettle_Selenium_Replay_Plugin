...
public class VerifyNotSelectedValue extends BaseCommand {

	public VerifyNotSelectedValue(SeleniumTestCase testCase, JSONObject json) {
		super(testCase, json);
	...
	public void run() throws KettleException {
		...
		assertThat(getElement().getAttribute("value"), is(not(getValue())));
