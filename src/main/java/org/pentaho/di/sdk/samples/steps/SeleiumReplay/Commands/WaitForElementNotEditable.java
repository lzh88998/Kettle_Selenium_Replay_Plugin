...
public class WaitForElementNotEditable extends BaseCommand {

	public WaitForElementNotEditable(SeleniumTestCase testCase, JSONObject json) {
		super(testCase, json);
	...
	public void run() throws KettleException {
		...
		wait.until(ExpectedConditions.not(ExpectedConditions.elementToBeClickable(getTargetLocator(getTarget()))));
