...
public class WaitForElementNotVisible extends BaseCommand {

	public WaitForElementNotVisible(SeleniumTestCase testCase, JSONObject json) {
		super(testCase, json);
	...
	public void run() throws KettleException {
		...
		wait.until(ExpectedConditions.not(ExpectedConditions.invisibilityOfElementLocated(getTargetLocator(getTarget()))));
